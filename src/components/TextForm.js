...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className="container" style={{color: props.mode==='dark'?'white':'#042743'}}> 
            ...
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleEncode64}>Encode_to_base64</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleDecode64}>Decode_to_base64</button>
            <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleListen}>Listen 🔊</button>
            {/* <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={translateToHindi}>translate</button> */}
          ...
          <button type="button" disabled={text.length === 0} className="btn btn-primary mt-2 me-2" onClick={handleAlphabetsClick} >Extract Alphabets</button>
